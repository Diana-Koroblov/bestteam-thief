...
def _send(
    ...
    # ours. The **timestamp**, not the date — two series against one opponent on
    # one afternoon share a calendar day, and merging them silently is what sent
    # imreeyal a half-stale report on 17/08 (`league_merge.SERIES_WINDOW`).
