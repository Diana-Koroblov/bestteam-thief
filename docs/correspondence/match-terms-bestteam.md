...
**Counted series played:** 1, against one distinct opponent (imreeyal, 2026-08-18)
...
Our counted figure is **1**, and §8 explains why we make that number mechanical rather than
remembered.
...
```
config_sha256 (bestteam ↔ imreeyal)  = cca1243e9a4b06611f77c98077613056a7490a5b27c0da1da06fc26f33b1a513
...
cop commit          68cbdd211dcfdd4de97039e92daa12f8a12d13ac      (branch itay)
thief repo          https://github.com/Diana-Koroblov/bestteam-thief
thief commit        91de6c78779d17558e8fbc1000e7e395e21ed243      (branch itay)
...
counted so far      1 — imreeyal, 2026-08-18, counted, we scored 40 to their 60
```
